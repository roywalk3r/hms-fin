...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>HMS Pro - Comprehensive Hospital Management System</title>

        <!-- Meta Descriptions -->
        <meta name="description" content="HMS Pro is a comprehensive hospital management system designed to streamline hospital operations, patient records, billing, and staff management. Enhance healthcare efficiency with our secure and user-friendly solution.">

        <!-- SEO Meta Tags -->
        <meta name="keywords" content="hospital management system, HMS Pro, patient management, healthcare software, hospital billing system, healthcare automation, hospital software solution">
        <meta name="author" content="HMS Pro Team">

        <!-- Social Media / Open Graph Tags -->
        <meta property="og:title" content="HMS Pro - Comprehensive Hospital Management System">
        <meta property="og:description" content="Streamline hospital operations with HMS Pro. Manage patients, billing, staff, and more with our secure and user-friendly solution.">
        <meta property="og:image" content="https://rseann.helioho.st/summary_large_image.png">
        <meta property="og:url" content="https://rseann.helioho.st">
        <meta property="og:type" content="website">

        <!-- Twitter Cards -->
        <meta name="twitter:card" content="summary_large_image.png">
        <meta name="twitter:title" content="HMS Pro - Comprehensive Hospital Management System">
        <meta name="twitter:description" content="Streamline hospital operations with HMS Pro. Manage patients, billing, staff, and more with our secure and user-friendly solution.">
        <meta name="twitter:image" content="https://rseann.helioho.st/summary_large_image.png">
    ...
    <!-- Hero Section -->
    <div class="relative bg-white overflow-hidden w-full flex justify-center pb-4" >
        <div class="max-w-7xl mx-auto">
            <div class="relative z-10 bg-white lg:w-full lg:max-w-2xl">
                <main class="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 lg:mt-20 lg:px-8">
                    <div class="text-center">
                        <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                            Welcome to
                            <span class="text-blue-600">Hospital Management System</span>
                        </h1>
                        <p class="mt-4 text-lg text-gray-500 sm:mt-6 sm:text-xl">
                            Manage patients, doctors, appointments, and hospital records with ease.
                        </p>
                        <div class="mt-8 flex justify-center">
                            <a href="/hms" wire:navigate class="px-8 py-3 text-white bg-blue-600 rounded-lg shadow-md hover:bg-blue-700">
                                Get Started
                            </a>
                        </div>
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:text-center">
                ...
                <p class="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
                    Simplifying hospital management for better patient care.
                </p>
            </div>
            ...
            <div class="mt-10">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div class="text-center">
                        <div class="flex items-center justify-center h-12 w-12 rounded-md bg-blue-100 mx-auto mb-4">
                            <svg class="h-6 w-6 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16l-4-4m0 0l4-4m-4 4h16" />
                            </svg>
                        </div>
                        <h3 class="text-lg font-medium text-gray-900">Easy Appointment Scheduling</h3>
                        <p class="mt-2 text-gray-500">Book and manage appointments seamlessly.</p>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="text-lg font-medium text-gray-900">Comprehensive Patient Records</h3>
                        <p class="mt-2 text-gray-500">All patient records stored securely in one place.</p>
                    </div>

                    <div class="text-center">
                        <div class="flex items-center justify-center h-12 w-12 rounded-md bg-blue-100 mx-auto mb-4">
                            <svg class="h-6 w-6 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c1.886 0 3.413-1.163 4-2.828C16.587 7.163 18.114 8 20 8m-8 8c-1.886 0-3.413 1.163-4 2.828C7.413 16.837 5.886 16 4 16m16-8v6m-16 0v6" />
                            </svg>
                        </div>
                        <h3 class="text-lg font-medium text-gray-900">Efficient Staff Management</h3>
                        <p class="mt-2 text-gray-500">Assign, track, and manage hospital staff effortlessly.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer class="bg-white border-t border-gray-200 py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <p class="text-center text-sm text-gray-500">
                Powered by <span class="font-semibold text-blue-600">Aerk Systems</span>
            </p>
        </div>
    </footer>
    </body>
